...
#define UNPACK_S0(s0, s1, t1)\
   ...
   s0 = _mm_castps_si128( _mm_insert_ps( _mm_castsi128_ps( s0 ), _mm_castsi128_ps( s0 ), 8 ) )
...
#define SUBROUND512_3(r1a, r1b, r1c, r1d, r2a, r2b, r2c, r2d, r3a, r3b, r3c, r3d)\
   ...
   _t0 = _mm_castps_si128( _mm_insert_ps( _mm_castsi128_ps( _t0 ), _mm_castsi128_ps( _t0 ), 8 ) ); \
