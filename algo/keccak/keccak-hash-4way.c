...
static void keccak64_8way_core(keccak64_ctx_m512i *kc, const void *data,
                               size_t len, size_t lim) {
  __m512i *buf;
...
void keccak256_8way_init(void *kc) { keccak64_8way_init(kc, 256); }
...
void keccak512_8way_init(void *kc) { keccak64_8way_init(kc, 512); }
...
static void keccak64_core(keccak64_ctx_m256i *kc, const void *data, size_t len,
                          size_t lim) {
  __m256i *buf;
...
void keccak256_4way_init(void *kc) { keccak64_init(kc, 256); }
...
void keccak512_4way_init(void *kc) { keccak64_init(kc, 512); }
