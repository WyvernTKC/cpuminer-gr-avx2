...
static inline void intrlv_2x32(void *dst, const void *src0, const void *src1,
                               const int bit_len) {
...
static inline void dintrlv_2x32(void *dst0, void *dst1, const void *src,
                                const int bit_len) {
...
static inline void extr_lane_2x32(void *dst, const void *src, const int lane,
                                  const int bit_len) {
  uint32_t *d = (uint32_t *)dst;
  const uint32_t *s = (const uint32_t *)src;
  d[0] = s[lane];
...
static inline void dintrlv_4x32(void *dst0, void *dst1, void *dst2, void *dst3,
...
static inline void extr_lane_4x32(void *d, const void *s, const int lane,
                                  const int bit_len) {
...
static inline void intrlv_8x32b(void *dst, const void *s0, const void *s1,
                                const void *s2, const void *s3, const void *s4,
...
static inline void extr_lane_8x32(void *d, const void *s, const int lane,
                                  const int bit_len) {
  ((uint32_t *)d)[0] = ((const uint32_t *)s)[lane];
...
static inline void mm256_bswap32_intrlv80_8x32(void *d, const void *src) {
  ...
  casti_m128i(d, 0) = casti_m128i(d, 1) = _mm_shuffle_epi32(s0, 0x00);
  casti_m128i(d, 2) = casti_m128i(d, 3) = _mm_shuffle_epi32(s0, 0x55);
  casti_m128i(d, 4) = casti_m128i(d, 5) = _mm_shuffle_epi32(s0, 0xaa);
  casti_m128i(d, 6) = casti_m128i(d, 7) = _mm_shuffle_epi32(s0, 0xff);

  casti_m128i(d, 8) = casti_m128i(d, 9) = _mm_shuffle_epi32(s1, 0x00);
  casti_m128i(d, 10) = casti_m128i(d, 11) = _mm_shuffle_epi32(s1, 0x55);
  casti_m128i(d, 12) = casti_m128i(d, 13) = _mm_shuffle_epi32(s1, 0xaa);
  casti_m128i(d, 14) = casti_m128i(d, 15) = _mm_shuffle_epi32(s1, 0xff);

  casti_m128i(d, 16) = casti_m128i(d, 17) = _mm_shuffle_epi32(s2, 0x00);
  casti_m128i(d, 18) = casti_m128i(d, 19) = _mm_shuffle_epi32(s2, 0x55);
  casti_m128i(d, 20) = casti_m128i(d, 21) = _mm_shuffle_epi32(s2, 0xaa);
  casti_m128i(d, 22) = casti_m128i(d, 23) = _mm_shuffle_epi32(s2, 0xff);

  casti_m128i(d, 24) = casti_m128i(d, 25) = _mm_shuffle_epi32(s3, 0x00);
  casti_m128i(d, 26) = casti_m128i(d, 27) = _mm_shuffle_epi32(s3, 0x55);
  casti_m128i(d, 28) = casti_m128i(d, 29) = _mm_shuffle_epi32(s3, 0xaa);
  casti_m128i(d, 30) = casti_m128i(d, 31) = _mm_shuffle_epi32(s3, 0xff);

  casti_m128i(d, 32) = casti_m128i(d, 33) = _mm_shuffle_epi32(s4, 0x00);
  casti_m128i(d, 34) = casti_m128i(d, 35) = _mm_shuffle_epi32(s4, 0x55);
  casti_m128i(d, 36) = casti_m128i(d, 37) = _mm_shuffle_epi32(s4, 0xaa);
  casti_m128i(d, 38) = casti_m128i(d, 39) = _mm_shuffle_epi32(s4, 0xff);
}
...
static inline void
intrlv_16x32(void *dst, const void *s00, const void *s01, const void *s02,
             const void *s03, const void *s04, const void *s05, const void *s06,
             const void *s07, const void *s08, const void *s09, const void *s10,
             const void *s11, const void *s12, const void *s13, const void *s14,
             const void *s15, const int bit_len) {
  ILEAVE_16x32(0);
  ILEAVE_16x32(1);
  ILEAVE_16x32(2);
  ILEAVE_16x32(3);
...
static inline void intrlv_16x32_512(void *dst, const void *s00, const void *s01,
                                    const void *s02, const void *s03,
                                    const void *s04, const void *s05,
                                    const void *s06, const void *s07,
                                    const void *s08, const void *s09,
                                    const void *s10, const void *s11,
                                    const void *s12, const void *s13,
                                    const void *s14, const void *s15) {
  ILEAVE_16x32(0);
  ILEAVE_16x32(1);
  ILEAVE_16x32(2);
  ILEAVE_16x32(3);
...
static inline void dintrlv_16x32(void *d00, void *d01, void *d02, void *d03,
                                 void *d04, void *d05, void *d06, void *d07,
                                 void *d08, void *d09, void *d10, void *d11,
...
static inline void dintrlv_16x32_512(void *d00, void *d01, void *d02, void *d03,
                                     void *d04, void *d05, void *d06, void *d07,
                                     void *d08, void *d09, void *d10, void *d11,
                                     void *d12, void *d13, void *d14, void *d15,
                                     const void *src) {
...
static inline void extr_lane_16x32(void *d, const void *s, const int lane,
                                   const int bit_len) {
  ((uint32_t *)d)[0] = ((const uint32_t *)s)[lane];
...
static inline void mm512_bswap32_intrlv80_16x32(void *d, const void *src) {
  ...
  casti_m128i(d, 0) = casti_m128i(d, 1) = casti_m128i(d, 2) =
      casti_m128i(d, 3) = _mm_shuffle_epi32(s0, 0x00);
  casti_m128i(d, 4) = casti_m128i(d, 5) = casti_m128i(d, 6) =
      casti_m128i(d, 7) = _mm_shuffle_epi32(s0, 0x55);
  casti_m128i(d, 8) = casti_m128i(d, 9) = casti_m128i(d, 10) =
      casti_m128i(d, 11) = _mm_shuffle_epi32(s0, 0xaa);
  casti_m128i(d, 12) = casti_m128i(d, 13) = casti_m128i(d, 14) =
      casti_m128i(d, 15) = _mm_shuffle_epi32(s0, 0xff);

  casti_m128i(d, 16) = casti_m128i(d, 17) = casti_m128i(d, 18) =
      casti_m128i(d, 19) = _mm_shuffle_epi32(s1, 0x00);
  casti_m128i(d, 20) = casti_m128i(d, 21) = casti_m128i(d, 22) =
      casti_m128i(d, 23) = _mm_shuffle_epi32(s1, 0x55);
  casti_m128i(d, 24) = casti_m128i(d, 25) = casti_m128i(d, 26) =
      casti_m128i(d, 27) = _mm_shuffle_epi32(s1, 0xaa);
  casti_m128i(d, 28) = casti_m128i(d, 29) = casti_m128i(d, 30) =
      casti_m128i(d, 31) = _mm_shuffle_epi32(s1, 0xff);

  casti_m128i(d, 32) = casti_m128i(d, 33) = casti_m128i(d, 34) =
      casti_m128i(d, 35) = _mm_shuffle_epi32(s2, 0x00);
  casti_m128i(d, 36) = casti_m128i(d, 37) = casti_m128i(d, 38) =
      casti_m128i(d, 39) = _mm_shuffle_epi32(s2, 0x55);
  casti_m128i(d, 40) = casti_m128i(d, 41) = casti_m128i(d, 42) =
      casti_m128i(d, 43) = _mm_shuffle_epi32(s2, 0xaa);
  casti_m128i(d, 44) = casti_m128i(d, 45) = casti_m128i(d, 46) =
      casti_m128i(d, 47) = _mm_shuffle_epi32(s2, 0xff);

  casti_m128i(d, 48) = casti_m128i(d, 49) = casti_m128i(d, 50) =
      casti_m128i(d, 51) = _mm_shuffle_epi32(s3, 0x00);
  casti_m128i(d, 52) = casti_m128i(d, 53) = casti_m128i(d, 54) =
      casti_m128i(d, 55) = _mm_shuffle_epi32(s3, 0x55);
  casti_m128i(d, 56) = casti_m128i(d, 57) = casti_m128i(d, 58) =
      casti_m128i(d, 59) = _mm_shuffle_epi32(s3, 0xaa);
  casti_m128i(d, 60) = casti_m128i(d, 61) = casti_m128i(d, 62) =
      casti_m128i(d, 63) = _mm_shuffle_epi32(s3, 0xff);

  casti_m128i(d, 64) = casti_m128i(d, 65) = casti_m128i(d, 66) =
      casti_m128i(d, 67) = _mm_shuffle_epi32(s4, 0x00);
  casti_m128i(d, 68) = casti_m128i(d, 69) = casti_m128i(d, 70) =
      casti_m128i(d, 71) = _mm_shuffle_epi32(s4, 0x55);
  casti_m128i(d, 72) = casti_m128i(d, 73) = casti_m128i(d, 74) =
      casti_m128i(d, 75) = _mm_shuffle_epi32(s4, 0xaa);
  casti_m128i(d, 76) = casti_m128i(d, 77) = casti_m128i(d, 78) =
...
static inline void intrlv_2x64(void *dst, const void *src0, const void *src1,
                               const int bit_len) {
...
static inline void dintrlv_2x64(void *dst0, void *dst1, const void *src,
                                const int bit_len) {
...
static inline void intrlv_4x64(void *dst, const void *src0, const void *src1,
                               const void *src2, const void *src3,
                               const int bit_len) {
...
static inline void dintrlv_4x64(void *dst0, void *dst1, void *dst2, void *dst3,
                                const void *src, const int bit_len) {
...
static inline void extr_lane_4x64(void *d, const void *s, const int lane,
                                  const int bit_len) {
...
static inline void mm256_intrlv80_4x64(void *d, const void *src) {
  ...
  casti_m128i(d, 0) = casti_m128i(d, 1) = _mm_shuffle_epi32(s0, 0x44);
  casti_m128i(d, 2) = casti_m128i(d, 3) = _mm_shuffle_epi32(s0, 0xee);

  casti_m128i(d, 4) = casti_m128i(d, 5) = _mm_shuffle_epi32(s1, 0x44);
  casti_m128i(d, 6) = casti_m128i(d, 7) = _mm_shuffle_epi32(s1, 0xee);

  casti_m128i(d, 8) = casti_m128i(d, 9) = _mm_shuffle_epi32(s2, 0x44);
  casti_m128i(d, 10) = casti_m128i(d, 11) = _mm_shuffle_epi32(s2, 0xee);

  casti_m128i(d, 12) = casti_m128i(d, 13) = _mm_shuffle_epi32(s3, 0x44);
  casti_m128i(d, 14) = casti_m128i(d, 15) = _mm_shuffle_epi32(s3, 0xee);

  casti_m128i(d, 16) = casti_m128i(d, 17) = _mm_shuffle_epi32(s4, 0x44);
  casti_m128i(d, 18) = casti_m128i(d, 19) = _mm_shuffle_epi32(s4, 0xee);
}
...
static inline void intrlv_8x64(void *dst, const void *src0, const void *src1,
                               const void *src2, const void *src3,
                               const void *src4, const void *src5,
                               const void *src6, const void *src7,
                               const int bit_len) {
  __m128i *d = (__m128i *)dst;
  const __m128i *s0 = (const __m128i *)src0;
  const __m128i *s1 = (const __m128i *)src1;
...
static inline void intrlv_8x64_512(void *dst, const void *src0,
                                   const void *src1, const void *src2,
                                   const void *src3, const void *src4,
                                   const void *src5, const void *src6,
                                   const void *src7) {
  __m128i *d = (__m128i *)dst;
  const __m128i *s0 = (const __m128i *)src0;
  const __m128i *s1 = (const __m128i *)src1;
...
static inline void dintrlv_8x64(void *dst0, void *dst1, void *dst2, void *dst3,
...
static inline void dintrlv_8x64_512(void *dst0, void *dst1, void *dst2,
                                    void *dst3, void *dst4, void *dst5,
                                    void *dst6, void *dst7, const void *src) {
  __m128i *d0 = (__m128i *)dst0;
  __m128i *d1 = (__m128i *)dst1;
  __m128i *d2 = (__m128i *)dst2;
  __m128i *d3 = (__m128i *)dst3;
...
static inline void extr_lane_8x64(void *d, const void *s, const int lane,
                                  const int bit_len) {
  ((uint64_t *)d)[0] = ((const uint64_t *)s)[lane];
...
static inline void intrlv_2x128(void *dst, const void *src0, const void *src1,
                                const int bit_len) {
  __m128i *d = (__m128i *)dst;
  const __m128i *s0 = (const __m128i *)src0;
  const __m128i *s1 = (const __m128i *)src1;
...
static inline void dintrlv_2x128(void *dst0, void *dst1, const void *src,
                                 int bit_len) {
  __m128i *d0 = (__m128i *)dst0;
  __m128i *d1 = (__m128i *)dst1;
  const __m128i *s = (const __m128i *)src;
...
static inline void intrlv_4x128(void *dst, const void *src0, const void *src1,
                                const void *src2, const void *src3,
                                const int bit_len) {
  __m128i *d = (__m128i *)dst;
  const __m128i *s0 = (const __m128i *)src0;
...
static inline void dintrlv_4x128(void *dst0, void *dst1, void *dst2, void *dst3,
                                 const void *src, const int bit_len) {
  __m128i *d0 = (__m128i *)dst0;
  __m128i *d1 = (__m128i *)dst1;
  __m128i *d2 = (__m128i *)dst2;
...
static inline void intrlv_2x256(void *dst, const void *src0, const void *src1,
                                const int bit_len) {
...
// No 80 byte dintrlv
static inline void dintrlv_2x256(void *dst0, void *dst1, const void *src,
                                 int bit_len) {
...
static inline void rintrlv_4x64_4x32(void *dst, const void *src,
  ...
  RLEAVE_4x64_4x32(88);
  RLEAVE_4x64_4x32(96);
  RLEAVE_4x64_4x32(104);
  RLEAVE_4x64_4x32(112);
  RLEAVE_4x64_4x32(120);
}

#undef RLEAVE_4x64_4x32

#define RLEAVE_8x64_8x32(i)                                                    \
  do {                                                                         \
    uint32_t *d = (uint32_t *)dst + (i);                                       \
    const uint32_t *s = (const uint32_t *)src + (i);                           \
    d[0] = s[0];                                                               \
...
static inline void rintrlv_8x64_8x32(void *dst, const void *src,
  ...
  RLEAVE_8x64_8x32(80);
  RLEAVE_8x64_8x32(96);
  RLEAVE_8x64_8x32(112);

  if (bit_len <= 512)
    return;

  RLEAVE_8x64_8x32(128);
  RLEAVE_8x64_8x32(144);

  if (bit_len <= 640)
    return;

  RLEAVE_8x64_8x32(160);
  RLEAVE_8x64_8x32(176);
  RLEAVE_8x64_8x32(192);
  RLEAVE_8x64_8x32(208);
  RLEAVE_8x64_8x32(224);
  RLEAVE_8x64_8x32(240);
}
...
static inline void rintrlv_4x32_4x64(void *dst, const void *src,
                                     const int bit_len) {
  __m128i *d = (__m128i *)dst;
  const __m128i *s = (const __m128i *)src;
...
static inline void rintrlv_8x32_8x64(void *dst, const void *src,
                                     const int bit_len) {
  __m128i *d = (__m128i *)dst;
  const __m128i *s = (const __m128i *)src;
...
static inline void rintrlv_8x32_4x128(void *dst0, void *dst1, const void *src,
                                      const int bit_len) {
  RLEAVE_8X32_4X128(0);
  RLEAVE_8X32_4X128(16);
  if (bit_len <= 256)
    return;
  RLEAVE_8X32_4X128(32);
  RLEAVE_8X32_4X128(48);
  if (bit_len <= 512)
    return;
  ...
  RLEAVE_8X32_4X128(96);
  RLEAVE_8X32_4X128(112);
}
...
static inline void rintrlv_4x64_2x128(void *dst0, void *dst1, const void *src,
                                      const int bit_len) {
  __m128i *d0 = (__m128i *)dst0;
  __m128i *d1 = (__m128i *)dst1;
  const __m128i *s = (const __m128i *)src;
...
static inline void rintrlv_8x64_4x128(void *dst0, void *dst1, const void *src,
                                      const int bit_len) {
  __m128i *d0 = (__m128i *)dst0;
  __m128i *d1 = (__m128i *)dst1;
  const __m128i *s = (const __m128i *)src;
...
static inline void rintrlv_2x256_8x64(void *dst, const void *src0,
                                      const void *src1, const void *src2,
                                      const void *src3, const int bit_len) {
  __m128i *d = (__m128i *)dst;
...
#define mm512_intrlv_blend_32(hi, lo) _mm512_mask_blend_epi32(0x5555, hi, lo)
